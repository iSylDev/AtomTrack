...
export default function ErrorScreen() {
  ...
  return (
    <div className="flex flex-col gap-2 items-center justify-center h-screen">
      ...
      <div className="w-[80%] lg:w-[20%] flex flex-col gap-2 items-center justify-center">
        <div className="flex flex-col lg:flex-row gap-5 items-center justify-center w-full">
          ...
          <Button className="w-full mt-4 py-5 rounded-md lg:mt-5" variant={'outline'} >
        ...
        <Button
          onClick={() => logout()}
          disabled={isPending}
          className="w-full mt-4 py-5 rounded-md lg:mt-5" variant={'destructive'} >
