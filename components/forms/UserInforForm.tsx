...
export default function UserInfoForm() {
  ...
  return <form action="" className="w-full mt-6 flex flex-col gap-5 lg:mt-0 lg:gap-3 lg:flex-row">
    <Label className="flex flex-col gap-2 items-start w-full ">
      ...
      <Input disabled id="email" type="email" placeholder={'ikryptolily@gmail.com'} className="pl-4 py-5 placeholder:text-card-foreground rounded-sm placeholder:text-sm" />
    </Label>
